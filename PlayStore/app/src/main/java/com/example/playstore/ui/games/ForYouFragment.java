...
public class ForYouFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.for_you_fragment, container, false);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView appCollectionRV = view.findViewById(R.id.for_You_collection_holder);
        //appCollectionRV.hasFixedSize();
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getContext());
        appCollectionRV.setLayoutManager(layoutManager);

        List<CollectionData> CollectionList = new MyReader(getContext()).readGamesData(MyReader.SECTION_FOR_YOU);
